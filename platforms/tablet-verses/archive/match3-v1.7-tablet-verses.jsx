            ...
            {(() => {
              ...
              if (!isMultiLevel) {
                ...
                buttons.push({
                  ...
                  label: 'Arcade mode',
                  onClick: () => {
                    // V-4: arcade-mode handoff. Roll bankedMoves into
                    // tablet arcade's BANKED_KEY (the same key the
                    ...
                    try {
                      ...
                      const existing = parseInt(localStorage.getItem(BANKED_KEY) || '0', 10);
                      localStorage.setItem(BANKED_KEY, (existing + carryAmount).toString());

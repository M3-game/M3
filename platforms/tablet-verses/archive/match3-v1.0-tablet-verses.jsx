...
// =============================================================================
// MATCH-3 GAME v1.0 - TABLET VERSES (MEMORIZE MODE)
//
// Session V-1 (2026-04-24): Scaffold fork from tablet v11.11. Plumbing
// only — platform plays exactly like tablet arcade. Memorize mechanics
// (text bar, chunk reveal on settle, passage-reveal end screen, bonus-
// moves carry, arcade handoff) land in V-2 through V-5. See
// docs/DEFERRED.md "Memorize Mode (Verses platform)" for full scope.
//
// Changes vs. tablet v11.11:
//   - Component renamed: Match3Game → Match3Verses.
//   - In-game header: "🎮 Match-3 v11.11" → "Verses v1.0" (no emoji,
//     per scoping — content-driven title comes in V-2).
    ...
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{ margin: '0', color: '#333', fontSize: '20px', textShadow: '2px 2px 4px rgba(0,0,0,0.1)' }}>
          Verses <span style={{ fontSize: '12px', color: '#ccc' }}>v1.0</span>
        </h1>
        <div style={{
          display: 'flex',

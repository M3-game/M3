    ...
    >
      ...
      >
        ...
        >
          <div
            style={{
              ...
              opacity: combo > 0 || (lastCombo > 0 && gameState === 'playing') ? (combo > 0 ? 1 : 0.6) : 0,
              transition: 'opacity 0.3s'
            }}
          >
            {(combo > 0 || lastCombo > 0) && `🔥Combo x${comboDisplayValue + 1}`}
          </div>
          <h1 style={{ margin: '0', color: '#333', fontSize: '15px', fontWeight: 'bold' }}>
            M3 <span style={{ fontSize: '9px', color: '#999', fontWeight: 'normal' }}>v13.7</span>
          </h1>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '12px', fontWeight: 'bold', color: '#555' }}>
          ...
          <div>🎯<span style={{ color: '#667eea' }}>{levelTarget}</span></div>
        </div>

...
// =============================================================================
// MATCH-3 GAME v13.3 - PHONE 418PX (JSX)
//
// Session P-1 (2026-05-01): Responsive board sizing port from
// phone-418-verses v1.3 (N-6, 2026-05-01). Replaces the fixed 10×12
...
//   - All "banked" / "bonus round" terminology — phone-418 arcade is
...
// the board keeps its original size — phone-418 arcade is portrait-
// only in practice.
//
...
//
// =============================================================================
// MATCH-3 GAME v13.2 - PHONE 418PX (JSX)
//
// Session N-2 (2026-04-28): Phone-418-verses → phone-418 arcade
...
// arcade-mode handoff button on the phone-418-verses end-of-final-
// level modal (phone-418-verses v1.0, shipped this same N-2 commit).
//
...
// constant), so the carry pool feeds directly into phone-418 arcade's
// existing banked-moves storage on the next mount.
//
// =============================================================================
// MATCH-3 GAME v13.1 - PHONE 418PX (JSX)
//
// Session M-2 (2026-04-27): Backport v11.7 hypernova rework
// ("amplification, not interference") from tablet to phone-418. Surfaced
...
// "Variety through amplification, not interference"). Phone-418's
// v11.8 admin slow-motion playback hooks are intentionally NOT ported
// here — phone-418 doesn't have AdminPanel integration yet (separate
...
//
// =============================================================================
// MATCH-3 GAME v13.0 - PHONE 418PX (JSX)
//
...
//   - ReactDOM.createRoot mount moved out to src/entry-phone418.jsx.
...
//   - Run tracking: currentRun + longestRun persisted to phone-418-scoped
...
//
// Mirrors the same IIFE used in phone-418-verses v1.3 (N-6). Resize
...
// v12.4: localStorage keys for run tracking (phone-418-scoped — separate
...
const Match3Game = () => {
  // v13.2 (N-2, 2026-04-28): phone-418-verses → phone-418 arcade carry
  // banner. Reads the carry-receipt key written by phone-418-verses
  ...
  // Persisted in phone-418-scoped localStorage.
  ...
  return (
    ...
    >
      {/* v13.2 (N-2): verses → phone-418 arcade carry banner. Auto-
      ...
      >
        ...
        >
          ...
          <h1 style={{ margin: '0', color: '#333', fontSize: '15px', fontWeight: 'bold' }}>
            M3 <span style={{ fontSize: '9px', color: '#999', fontWeight: 'normal' }}>v13.1-418px</span>
          </h1>

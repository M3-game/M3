...
const Match3Game = () => {
  ...
  useEffect(() => {
    ...
    const checkTimer = setTimeout(() => {
      ...
      if (bonusRoundActive && moves <= 0) {
        ...
        const difficultyIncrease = DIFFICULTY_INCREMENT_MIN + Math.floor(Math.random() * (DIFFICULTY_INCREMENT_MAX - DIFFICULTY_INCREMENT_MIN + 1));
  ...
  }, [moves, gameState, levelTarget, highScore, isAnimating, combo, targetReached, pendingSpecials.length, grid, turnComplete, bonusRoundActive, showBonusPrompt, showBonusMovesPrompt, usingBonusMoves, bonusMoves]);
  ...
  const endGameCarryBanked = () => {
    ...
    if (wonLevel) {
      if (!targetReached) setTargetReached(true);
      const diffInc = DIFFICULTY_INCREMENT_MIN + Math.floor(Math.random() * (DIFFICULTY_INCREMENT_MAX - DIFFICULTY_INCREMENT_MIN + 1));
      ...
      >
        ...
        >
          ...
          <h1 style={{ margin: '0', color: '#333', fontSize: '15px', fontWeight: 'bold' }}>
            M3 <span style={{ fontSize: '9px', color: '#999', fontWeight: 'normal' }}>v14.0</span>
          </h1>

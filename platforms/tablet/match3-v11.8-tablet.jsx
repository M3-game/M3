...
// =============================================================================
// MATCH-3 GAME v11.8 - TABLET OPTIMIZED
...
// v11.2: Banked moves — persistent move savings across games
const BANKED_MOVES_CAP  = 25; // hard cap on stored moves
const BANKED_MOVES_WARN = 20; // counter turns amber above this
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          {bankedMoves > 0 && (
            <div title="Bonus moves carry forward to future games">
              Bonus moves: <span style={{
                color: usingBankedMoves ? '#e65100' :
                       bankedMoves >= BANKED_MOVES_CAP  ? '#e53935' :
                       bankedMoves >= BANKED_MOVES_WARN ? '#fb8c00' : '#667eea',
                fontWeight: 'bold'
              }}>{bankedMoves}</span>
            </div>
          )}

...
// =============================================================================
// MATCH-3 GAME v11.10 - TABLET OPTIMIZED
...
const ScoringHistoryPanel = ({ history, expandedTurns, setExpandedTurns, onClose, onHighlightTiles }) => {
  ...
  const S = {
    ...
    subtitle: { fontSize: '10px', color: '#888', letterSpacing: '1px', textTransform: 'uppercase' },
    btn: { background: '#2a2a2a', color: '#aaa', border: 'none', borderRadius: '4px', cursor: 'pointer', fontSize: '12px', padding: '4px 8px', fontFamily: 'monospace' },
    ...
    eventRow: { padding: '3px 8px 3px 14px', fontSize: '11px', cursor: 'pointer', color: '#bbb', borderLeft: '2px solid #333', marginLeft: '4px' },
    eventRowHover: { background: '#2a2a2a' },
    eventDesc: { display: 'block', color: '#ccc' },
    eventMeta: { display: 'block', color: '#666', fontSize: '10px' },
  ...
  return (
    <div style={S.panel}>
      ...
      <div style={S.body}>
        {history.length === 0 && (
          <div style={{ color: '#666', fontSize: '11px', textAlign: 'center', padding: '30px 10px' }}>
            ...
            <div key={turn.turnNumber}>
              ...
              >
                <span>
                  ...
                  <span style={{ color: '#666', marginLeft: '6px' }}>({turn.events.length} events)</span>
                </span>
...
const TabletAdminWrapper = ({
  ...
  const S = {
    ...
    speedBtn: (active) => ({ padding: '6px 14px', borderRadius: '6px', border: active ? '2px solid #4fc3f7' : '1px solid #333', background: active ? '#0d1b3e' : '#1e1e1e', color: active ? '#4fc3f7' : '#888', cursor: 'pointer', fontSize: '12px', fontFamily: 'monospace', fontWeight: 'bold', marginRight: '6px' }),
  };
  ...
  return (
    <div style={S.overlay}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '16px' }}>
        <div>
          ...
          <div style={{ fontSize: '11px', color: '#555' }}>
            Access: <span style={{ color: '#777' }}>?admin=1</span> · long-press score · <span style={{ color: '#777' }}>?playback=1</span> → history on
          </div>
        </div>
      ...
      <div style={S.card}>
        ...
        <div style={S.row}>
          <span style={{ color: '#aaa' }}>Scoring history panel</span>
          <button
            style={{ ...S.btn, background: showHistoryPanel ? '#1b3a1a' : '#2a2a2a', color: showHistoryPanel ? '#81c784' : '#888' }}
        ...
        <div style={{ ...S.row, flexWrap: 'wrap' }}>
          <span style={{ color: '#aaa' }}>Playback speed</span>
          <div>
        ...
        <div style={{ ...S.row, marginTop: '4px' }}>
          <span style={{ color: '#888', fontSize: '11px' }}>Clear accumulated history</span>
          <button
    ...
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{ margin: '0', color: '#333', fontSize: '20px', textShadow: '2px 2px 4px rgba(0,0,0,0.1)' }}>
          🎮 Match-3 <span style={{ fontSize: '12px', color: '#888' }}>v11.10</span>
        </h1>
        <div style={{
          display: 'flex',

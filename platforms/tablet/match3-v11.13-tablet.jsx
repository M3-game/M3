...
//     ([line ~3908]) now routes through `requestEndLevelCarryBanked`
//     (the wrapper that already powers the in-header button) instead
//     of calling `endLevelCarryBanked` directly. The wrapper
...
const Match3Game = () => {
  ...
  // (in showBankedMovesPrompt, line ~3908) now also routes through this

...
// =============================================================================
// MATCH-3 GAME v10.6.2 - TIME ATTACK MODE (DESKTOP)
...
const Match3Game = () => {
  ...
  // Helper: Add time extension
  const addTimeExtension = (reason) => {
    setTimeRemaining(prev => prev + TIME_EXTENSION_AMOUNT);
    setTotalTimeExtended(prev => prev + TIME_EXTENSION_AMOUNT);
  ...
  // v10.4: Track bonus move thresholds
  useEffect(() => {
    if (gameState !== 'playing') return;
    ...
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{ margin: '0', color: '#333', fontSize: '20px', textShadow: '2px 2px 4px rgba(0,0,0,0.1)' }}>
          ⏱️ TIME ATTACK <span style={{ fontSize: '12px', color: '#888' }}>v10</span>
        </h1>

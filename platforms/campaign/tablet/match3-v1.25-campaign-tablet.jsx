...
// =============================================================================
// MATCH-3 GAME — CAMPAIGN MODE v1.25 — TABLET
    ...
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{ margin: '0', color: '#333', fontSize: '18px' }}>
          ...
          <span style={{ fontSize: '11px', color: '#888', marginLeft: '6px' }}>v1.25</span>
        </h1>
  ...
  return (
    <div style={S.overlay}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '16px' }}>
        <div>
          ...
          <div style={{ fontSize: '11px', color: '#555' }}>
            Long-press "Campaign Mode" title or use <span style={{ color: '#777' }}>?admin=1</span>
          </div>
        </div>
      ...
      <div style={S.card}>
        ...
        <div style={{ fontSize: '12px', color: '#999', lineHeight: 1.5, marginBottom: '10px' }}>
        ...
        <div style={{ marginTop: '10px' }}>
          <button
            ...
            style={{
              ...
              color: confirmRestore ? '#f87171' : (importText.trim() ? '#ffcc80' : '#555'),

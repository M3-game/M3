...
// =============================================================================
// MATCH-3 GAME — CAMPAIGN MODE v1.8 — TABLET
...
const CampaignGame = ({ levelIndex, onLevelComplete, onBackToMap }) => {
  ...
  useEffect(() => {
    ...
    if (threshold > 0 && threshold > bonusMoveThresholdRef.current) {
      ...
      if (!IS_TIME_ATTACK) {
        // Bonus moves go directly into campaignBonusMoves (v1.8 — one unified pool)
  ...
  useEffect(() => {
    ...
    const checkTimer = setTimeout(() => {
      ...
      // Using banked moves: each swap consumed from campaignBonusMoves.
    ...
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{ margin: '0', color: '#333', fontSize: '18px' }}>
          ...
          <span style={{ fontSize: '11px', color: '#888', marginLeft: '6px' }}>v1.8</span>
        </h1>
      ...
      {/* Banked Moves Prompt — shown when regular moves hit 0 and 🏦 > 0 */}

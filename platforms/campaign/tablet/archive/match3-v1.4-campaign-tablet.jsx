...
// =============================================================================
// MATCH-3 GAME — CAMPAIGN MODE v1.4 — TABLET
...
const CampaignGame = ({ levelIndex, onLevelComplete, onBackToMap }) => {
  ...
  const activateSpecialCombination = (row1, col1, row2, col2, type1, type2, currentGrid) => {
    ...
    // Cascade: any special tiles swept up by the combination activate and chain.
    // The two original specials are excluded (already handled by the combo logic above).
    ...
    while (ci < tilesToRemove.length) {
      ...
      if (ct?.special && !processedInCombination.has(ck)) {
        ...
        if (result.message) message += ` ⛓️ ${result.message}`;
    ...
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{ margin: '0', color: '#333', fontSize: '18px' }}>
          ...
          <span style={{ fontSize: '11px', color: '#888', marginLeft: '6px' }}>v1.4</span>
        </h1>

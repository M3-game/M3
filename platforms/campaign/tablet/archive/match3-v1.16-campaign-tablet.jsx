...
const LEVEL_INTROS = [
  ...
  {
    icon: '🎮',
    heading: 'Welcome to Campaign!',
    bullets: [
      'Swap adjacent tiles to match 3 or more of the same colour',
...
const Match3Campaign = () => {
  ...
  const handleLevelComplete = ({ levelIndex, score, stars, won, bonusMovesEarned, bonusMovePoolTotal, movesUsed, bestCombo, specialsCreated }) => {
    ...
    if (won) {
      const campaignTotalScore = newHighScores.reduce((a, b) => a + (b || 0), 0);
      setTransitionData({ levelIndex, score, stars, bonusMovesEarned, bonusMovePoolTotal, movesUsed, bestCombo, specialsCreated, campaignTotalScore });

...
// v1.22: Fix — bonus move prompt now fires after bonus round ends
...
//   if > 0, end the bonus round and show the prompt instead of resolving.
            ...
            <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', marginBottom: '12px' }}>
              ...
              <button
                onClick={() => {
                  ...
                  setBonusMoveFlash(0);
                  setUsingBankedMoves(false); usingBankedMovesRef.current = false; setShowBankedMovesPrompt(false); setShowTimeUpPrompt(false); setPendingTimeExpiry(false); setGraceActive(false); setShowEndConfirm(false);
                }}

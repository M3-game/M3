...
// =============================================================================
// MATCH-3 GAME v1.0 — TABLET REWARD-MODE SANDBOX
//
// Sibling platform forked from platforms/tablet/match3-v11.11-tablet.jsx.
// Independent versioning (v1.0 start), independent admin UI.
//
// Session H₁ (scaffold only): adds 5 reward-mode lever controls to the
// admin wrapper (TILE_TYPES_COUNT, NEIGHBOR_MATCH_BIAS,
// CLUSTER_SEED_ON_START, CLUSTER_DROP_BIAS, SPECIAL_DROP_ON_BIG_TURN
// with threshold/super/hyper sub-values). Sliders render, persist to
// sessionStorage with `m3_rwd_*` prefixed keys, and accept kebab-case
// URL param overrides. Levers are NOT yet wired into game logic —
// the board still plays exactly like tablet v11.11.
//
// Session H₂ (future): wire the 5 levers into initializeGrid /
// applyGravity refill / cascade-end hooks.
//
      ...
      <div style={S.card}>
        ...
        <div style={{ ...S.row, marginTop: '10px', paddingTop: '10px', borderTop: '1px solid #2e2e2e' }}>
          <span style={{ color: '#ccc', fontSize: '12px' }}>
            H₁ scaffold — levers persist but are not yet wired into game logic
          </span>
          <button
...
const Match3Rewardmode = () => {
  ...
  // H₁ scaffold: reward-mode lever values (URL param → sessionStorage → defaults).
  // Values persist on change but DO NOT yet affect game logic — H₂ wires them in.
    ...
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{ margin: '0', color: '#333', fontSize: '20px', textShadow: '2px 2px 4px rgba(0,0,0,0.1)' }}>
          🎮 Match-3 Reward <span style={{ fontSize: '12px', color: '#ccc' }}>v1.0-sandbox</span>
        </h1>
        <div style={{
          display: 'flex',

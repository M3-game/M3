    ...
    <div style={{
      ...
      <div style={{
        ...
        {/* V-3b: title + (optional) inline "Level N of M" indicator
            ...
            work. */}
        {/* v1.12: on phone, long verses titles get a smaller font + a
            right-nudge so the centered title + "N/M" don't run under the
            top-left "See passage" button (free space on the right). Char-
            length tiers: > 20 → 16px; 15–20 → 18px; ≤ 14 → 20px. Titles over
            14 chars get the 48px left-pad nudge. Mirrors phone-verses v2.2. */}
        <h1 style={{
          margin: '0',
          color: '#333',
          ...
          {VERSES_MODE && versesGame ? (
            ...
            <>VERSES-SANDBOX <span style={{ fontSize: '12px', color: '#ccc' }}>v1.12</span></>
          )}
        </h1>

...
// =============================================================================
// MATCH-3 GAME v1.0 — TABLET SIM (headless simulation sibling)
//
...
//
// E-1b (future): admin UI wrapping _SIM — preset buttons for batch
//   runs (10 / 50 / 200), progress indicator, win-rate + score-
//   distribution stats, clipboard-copy JSON.
//
// E-1a scope notes:
...
//   - Bonus round SKIPPED — game ends at score ≥ target or moves = 0.
...
const _SIM = (() => {
  ...
  function runGame(opts = {}) {
    ...
    while (score < levelTarget && (moves > 0 || bonusMoves > 0)) {

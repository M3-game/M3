...
// =============================================================================
// MATCH-3 GAME v1.1 — TABLET SIM (headless simulation sibling)
//
...
const _SIM = (() => {
  ...
  function runGame(opts = {}) {
    ...
    const levelTarget = opts.levelTarget ?? (BASE_TARGET + Math.floor(Math.random() * TARGET_VARIANCE));
    ...
    while (moves > 0 || bonusMoves > 0) {
      ...
      bonusMoves += Math.max(0, newN - oldN);

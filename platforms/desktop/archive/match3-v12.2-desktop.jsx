...
// =============================================================================
// MATCH-3 GAME v12.2 - DESKTOP (T-2 terminology rename)
//
...
// applied to tablet/tablet-verses/phone-verses; T-2 completes the sweep
...
//   The constant `BONUS_MOVES_KEY` (renamed from `BANKED_MOVES_KEY`)
//   keeps its value 'match3_desktop_bankedMoves'. T-3 migrates this
//   value (and all other `bankedMoves` storage strings across all
//   platforms) in a single coordinated lockstep event. Renaming the
//   value here would orphan player progress without a migration.
//
// Stats-data layer (per Option A continuation): `endType: 'bonusRound'`
// in `recordGameResult()` — wait, desktop doesn't currently call
// recordGameResult (no AdminPanel integration). N/A here.
//
...
const BONUS_MOVES_KEY = 'match3_desktop_bankedMoves';
    ...
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{ margin: '0', color: '#333', fontSize: '20px', textShadow: '2px 2px 4px rgba(0,0,0,0.1)' }}>
          🎮 Match-3 <span style={{ fontSize: '12px', color: '#888' }}>v12</span>
        </h1>
        <div style={{
          display: 'flex',

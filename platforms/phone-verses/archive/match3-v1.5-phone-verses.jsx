...
// =============================================================================
// MATCH-3 GAME v1.5 - PHONE VERSES (T-3a stats-blob writes)
//
...
// lockstep on phone keys (the 5 phone storage strings preserved
// here under their P-2-noted CROSS-PLATFORM CONTRACT).
//
// =============================================================================
...
// Phone arcade (deferred T-1 platform) still reads this exact key
...
// renamed in lockstep with phone arcade — captured as a hard
// requirement in DEFERRED.md "Cross-platform terminology sweep" entry.
const PHONE_BONUS_MOVES_KEY = 'match3_phone418_bankedMoves';
      ...
      <div style={{
        ...
        <h1 style={{ margin: '0', color: '#333', fontSize: '20px', textShadow: '2px 2px 4px rgba(0,0,0,0.1)' }}>
          {VERSES_MODE && versesGame ? (
            ...
            <>Verses <span style={{ fontSize: '12px', color: '#ccc' }}>v1.4.1</span></>
          )}
        </h1>
              ...
              if (!isMultiLevel) {
                ...
                buttons.push({
                  ...
                  onClick: () => {
                    ...
                    // m3_arcade_carry_from_verses_phone418 so phone

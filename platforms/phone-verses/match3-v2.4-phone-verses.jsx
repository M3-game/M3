...
const VersesGame = ({
  ...
  return (
    <div style={{
      ...
      // v2.4: was `padding: '0 0 60px 0'`. phone-verses.html sets
      // viewport-fit=cover + black-translucent status bar, which run the page
      // under the status bar/notch; nothing compensated for it, so the status
      // bar sat on the title. Longhands (not the shorthand) so paddingTop
      // can't be clobbered by property order.

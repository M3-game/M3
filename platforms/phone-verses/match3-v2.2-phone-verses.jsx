      ...
      <div style={{
        ...
        {/* v2.2: on phone, long verses titles get (a) a smaller font and
            ...
            shift into it rather than squeeze the left). Char-length tiers:
              > 20 (e.g. "1 Thessalonians 4:13–18", 23) → 16px
              15–20 (e.g. "Isaiah 52:13–53:12" 18, "Genesis 50:15–21" 16) → 18px
              ≤ 14 (e.g. "Psalm 46", "Titus 2:11–13") → 20px, centered, no nudge
            Everything over 14 chars gets the 48px left-pad nudge. */}
        <h1 style={{
          margin: '0',
          color: '#333',
          fontSize: (VERSES_MODE && versesGame && versesGame.title && versesGame.title.length > 20) ? '16px'
                  ...
                  : '20px',
          paddingLeft: (VERSES_MODE && versesGame && versesGame.title && versesGame.title.length > 14) ? '48px' : '0',
